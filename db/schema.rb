...
ActiveRecord::Schema.define(version: 20160518213132) do

  create_table "arrangement_comments", force: :cascade do |t|
  ...
  create_table "arrangement_students", force: :cascade do |t|
    t.integer  "arrangement_id"
